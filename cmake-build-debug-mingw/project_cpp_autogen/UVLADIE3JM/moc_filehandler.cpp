...
Q_CONSTINIT const QMetaObject FileHandler::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSFileHandlerENDCLASS_t,
        ...
        // method 'onAddVideoButtonClicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'onVideoItemDoubleClicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void FileHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->onAddVideoButtonClicked(); break;
        case 2: _t->onVideoItemDoubleClicked((*reinterpret_cast< std::add_pointer_t<QListWidgetItem*>>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &FileHandler::fileSelected; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void FileHandler::fileSelected(const QString & _t1)
{
