...
struct qt_meta_stringdata_CLASSFilterSettingsENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSFilterSettingsENDCLASS = QtMocHelpers::stringData(
    "FilterSettings",
    "settingsChanged",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSFilterSettingsENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject FilterSettings::staticMetaObject = { {
    ...
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSFilterSettingsENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<FilterSettings, std::true_type>,
...
void FilterSettings::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<FilterSettings *>(_o);
        (void)_t;
        switch (_id) {
        ...
        {
            using _t = void (FilterSettings::*)();
            if (_t _q_method = &FilterSettings::settingsChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void FilterSettings::settingsChanged()
{
